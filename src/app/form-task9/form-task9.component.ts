...
@Component({
  selector: 'app-form-task9',
  templateUrl: './form-task9.component.html',
  styleUrls: ['./form-task9.component.css']
})
export class FormTask9Component implements OnInit {
  flag3 : boolean = true;
  flag4 : boolean = false;
  flag5 : boolean = false;
  flag6 : boolean = false;
  ...
  constructor(private ang:FormBuilder, private data:FormServiceService) { }
      ...
      {
        {
          ...
          {
            console.log('Qualification Details',this.qualificationForm.value);
          }
          );}
